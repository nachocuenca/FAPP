    ...
    operations = [
        ...
        migrations.AddField(
            ...
            fields=[
                ...
                ('cif', models.CharField(blank=True, max_length=15, null=True)),
                ...
                ('serie_facturas', models.CharField(default='A', max_length=10)),
                ('inicio_serie_facturas', models.IntegerField(default=1)),
                ('pie_factura', models.TextField(blank=True, null=True)),
                ('notas_factura', models.TextField(blank=True, null=True)),
                ('color_primario', models.CharField(default='#000000', max_length=7)),
                ('fuente_factura', models.CharField(blank=True, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fecha', models.DateField()),
                ('estado', models.CharField(choices=[('pendiente', 'Pendiente'), ('en_curso', 'En curso'), ('realizado', 'Realizado')], default='pendiente', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('irpf', models.DecimalField(decimal_places=2, default=0.0, max_digits=5)),
                ('total', models.DecimalField(decimal_places=2, max_digits=10)),
                ('estado', models.CharField(choices=[('borrador', 'Borrador'), ('emitida', 'Emitida'), ('pagada', 'Pagada')], default='borrador', max_length=20)),
                ('actuaciones', models.ManyToManyField(to='core.actuacion')),
                ('cliente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.cliente')),
                ('usuario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(choices=[('producto', 'Producto'), ('servicio', 'Servicio')], default='servicio', max_length=20)),
                ('cliente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.cliente')),
                ('usuario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),        ),
